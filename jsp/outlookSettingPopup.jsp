	...
	<script>	
		...
		// ********************************************************************************************
			                    ...
			                    cols: [
			                        {
			                            ...
			                            html: `
			                            	<div class="manual_box">
			                            		<img src="../../acms/image/login/outlook_manual.jpg" >
			                            	</div>
			                            `
			                        },
			                        {
			                            ...
			                            html: `
			                                <div class="manual_box">
			                                    <img src="../../acms/image/login/outLook2016_manual.jpg" >
			                                </div>
			                            `
			                        }
			                    ]
			...
			let tabbar = setWidgetConfig({
				...
				items: [
					{id: 'outlook', text: 'Outlook', target: layout.outlook},
					{id: 'outlook_2016', text: 'outlook_2016', target: layout.outlook_2016}
				]
			});
