...
public class FrmDTO extends CommonDTO {
	private long frmSeq;
	...
	private String attachFileGrpNm;
	private String attachFileGrpId;
	...
	public static List<String> getConvertedFields() {
		return Arrays.stream(FrmDTO.class.getDeclaredFields())
				.map(Field::getName)
				.map(FrmDTO::toUpperSnakeCase)
				.collect(Collectors.toList());
	}
	@JsonIgnore
	public List<Object> getFieldValues() {
		List<Object> fieldValues = new ArrayList<>();
		List<String> fieldNames = Arrays.stream(FrmDTO.class.getDeclaredFields())
				.map(Field::getName)
				.collect(Collectors.toList());
